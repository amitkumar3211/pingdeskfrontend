    ...
    <div className="bg-white font-sans text-gray-900 antialiased overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm font-semibold text-violet-600 uppercase tracking-wider mb-4">Slack Ticketing for {data.name}</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <a
              ...
              onClick={() => events.addToSlackClick(`industry_${industry}`)}
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight text-center mb-6">
            Common challenges for {data.name.toLowerCase()}
          </h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight text-center mb-12">
            How {data.name.toLowerCase()} use Pingdesk
          </h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="https://pindeskapi.himalayancoders.com/slack/install"
            onClick={() => events.addToSlackClick(`industry_${industry}_bottom`)}
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-gray-900 text-center mb-8">Pingdesk for other teams</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {industries.filter((i) => i.slug !== industry).map((i) => (
              <a
                key={i.slug}
                href={`/slack-ticketing-for-${i.slug}`}
