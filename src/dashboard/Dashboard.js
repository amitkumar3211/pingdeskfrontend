          ...
          {workspace.is_pro ? (
            ...
            <div className="mt-10 relative rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 px-8 py-12 md:px-12 text-center">
                ...
                <p className="text-white/60 text-sm mb-8 max-w-md mx-auto">Unlock weekly charts, team performance analytics, CSV export, custom reminders, and unlimited requests.</p>
